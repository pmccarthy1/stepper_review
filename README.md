...
### Source
Figma file: [Sequoia Library 🛠](https://www.figma.com/design/xqGRr0rtzmhlyqzMrQelYN/Sequoia-Library-%F0%9F%9B%A0?node-id=4196-43828)
Node inspected: `4196:43828` (Stepper page — Stepper Organism + Atoms/Molecules sections)
...
cd /tmp && rm -rf stepper_deploy && mkdir stepper_deploy
cp /path/to/stepper-prototype/index.html stepper_deploy/index.html
cd stepper_deploy
git init && git checkout --orphan gh-pages
git add index.html && git commit -m "update prototype"
git remote add origin https://github.com/pmccarthy1/stepper_review.git
